...
if args.dataset != 'imdb':
    result_addr = f'{result_addr}/OnlineNLP/{args.exp_type}/{args.model_type}/{args.dataset}/p{str(int(args.availprob*100))}/Experiment_{args.exp_num}.data' 
else:
    result_addr = f'{result_addr}/OnlineNLP/{args.exp_type}/{args.model_type}/{args.dataset}/Experiment_{args.exp_num}.data'
